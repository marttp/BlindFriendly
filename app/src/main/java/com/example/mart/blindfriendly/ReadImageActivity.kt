...
class ReadImageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        environmentRecognition.movementMethod = ScrollingMovementMethod()
        openCameraEnvironment.setOnClickListener {
            openCameraIntent()
        }
        openGalleryEnvironment.setOnClickListener {
            openGalleryIntent()
        }
    }
            ...
            CAMERA_REQUEST_CODE -> {
                if(resultCode == Activity.RESULT_OK) {
                    try {
                        ...
                        Log.i("Uri","$uri")
                        imageEnvironmentView.setImageURI(uri)
                        ...
                        environmentRecognition.text = null
